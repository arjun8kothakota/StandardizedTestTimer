...
public class ActReading extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_act_reading);
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final long millisInFuture = 2100000;
                ...
                new CountDownTimer(millisInFuture, countDownInterval) {
                    ...
                    public void onTick(long millisUntilFinished) {
                        ...
                        if (isCancelled) {
                            ...
                            timeTxt.setText(hms);
                            int progress = (i*100/(2100000/1000));
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ActReading.this);
                alertDialogBuilder
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (textView.getText() == string) {
                                    Intent intent = new Intent(ActReading.this, ActScience.class);
    ...
    public void onBackPressed() {
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        isPaused = true;
                        Intent intent = new Intent(ActReading.this, HomePage.class);
                        startActivity(intent);
                    }
                }).setNegativeButton("No", new DialogInterface.OnClickListener() {
            @Override
