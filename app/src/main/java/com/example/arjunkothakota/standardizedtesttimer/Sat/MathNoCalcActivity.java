...
public class MathNoCalcActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_no_calc);
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final long millisInFuture = 1200000;
                ...
                new CountDownTimer(millisInFuture, countDownInterval) {
                    ...
                    public void onTick(long millisUntilFinished) {
                        ...
                        if (isCancelled) {
                            ...
                            timeTxt.setText(hms);
                            int progress = (i*100/(1200000/1000));
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(MathNoCalcActivity.this);
                alertDialogBuilder
    ...
    public void onBackPressed() {
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        isPaused = true;
                        Intent intent = new Intent(MathNoCalcActivity.this, HomePage.class);
                        startActivity(intent);
                    }
                }).setNegativeButton("No", new DialogInterface.OnClickListener() {
            @Override
