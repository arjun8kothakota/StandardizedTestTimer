...
import com.example.arjunkothakota.standardizedtesttimer.Act.ActReading;
...
public class SatBreak1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sat_break1);
        ...
        new CountDownTimer(millisInFuture, countDownInterval){
            ...
            public void onFinish() {
                ...
                mediaPlayer.start();
                if (textView.getText() == "") {
                    Intent intent = new Intent(SatBreak1.this, ActReading.class);
...
//Task for timer to execute when time expires
        ...
        continueBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(SatBreak1.this);
                alertDialogBuilder
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                isPaused = true;
                                if (textView.getText() == "") {
                                    Intent intent = new Intent(SatBreak1.this, WritingActivity.class);
                                    startActivity(intent);
                                }else {
                                    Intent intent = new Intent(SatBreak1.this, WritingActivity.class);
                                    intent.putExtra("noessay", string);
    ...
    public void onBackPressed() {
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        isPaused = true;
                        Intent intent = new Intent(SatBreak1.this, HomePage.class);
                        startActivity(intent);
                    }
                }).setNegativeButton("No", new DialogInterface.OnClickListener() {
            @Override
