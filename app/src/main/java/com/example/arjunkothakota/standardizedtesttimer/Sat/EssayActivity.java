    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final long millisInFuture = 3000000;
                ...
                new CountDownTimer(millisInFuture, countDownInterval) {
                    ...
                    public void onTick(long millisUntilFinished) {
                        ...
                        if (isCancelled) {
                            ...
                            timeTxt.setText(hms);
                            int progress = (i*100/(3000000/1000));
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(EssayActivity.this);
                alertDialogBuilder
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                isPaused = true;
                                Intent intent = new Intent(EssayActivity.this, HomePage.class);
